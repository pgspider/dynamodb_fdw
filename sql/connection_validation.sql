...
-- Drop foreign tables and create without partition_key and sort_key for 
-- foreign tables
--Testcase 6:
...
-- Drop foreign tables and create with invalid partition_key and valid sort_key for
-- foreign tables
--Testcase 13:
DROP FOREIGN TABLE connection_tbl;
--Testcase 14:
...
-- Drop foreign tables and create with valid partition_key and invalid sort_key for
-- foreign tables
--Testcase 20:
DROP FOREIGN TABLE connection_tbl;
--Testcase 21:
